$tasksFile   = "E:\OneDrive\Collection system\TASKS-hagict.md"
$repoPath    = "E:\repos\HagICTWeb\frontend"
$logFile     = "E:\OneDrive\Collection system\pipeline-hagict.log"
$changesPath = "E:\OneDrive\Collection system\Changes\hagict"
$lastHash    = ""
...
function Run-Builder($task, $taskId) {
    ...
    $prompt = "Lees CLAUDE.md in $repoPath. Implementeer de volgende feature volledig in de React 19 + Vite frontend: TAAK: $task. Volg alle architectuurregels uit CLAUDE.md. CSS Modules voor styling, geen externe UI libraries, inline SVG voor iconen, enkelvoudige scrollpagina met anchor links. Maak GEEN git commit. Schrijf daarna $repoPath\build-report.md met: 1) Samenvatting van wat je hebt gebouwd. 2) Exacte lijst van aangemaakt of gewijzigde bestanden."
...
Send-Notification "HAG-ICT watcher is online."
